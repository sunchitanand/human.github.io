  ...
  return (
    <AppBar position="static" color="primary" elevation={0}>
      <Toolbar sx={{ backgroundColor: 'white' }}>
        <Typography variant="h6" component="div" sx={{ flexGrow: 1, color: 'black', cursor: 'pointer', zIndex: 2, fontFamily: 'Avenir-Black, Poppins-Black', fontWeight: 'bold'}} onClick={() => window.location.href = '/'}>
          Tadaa
        </Typography>
        <div>
